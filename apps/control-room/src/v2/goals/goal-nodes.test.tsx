...
const RUNS: RunsOutcome = {
  goals: [{
    ...
    nodes: [{
      accepted: { verifierReceiptId: "receipt-1" }, claim: null, criterionIds: ["crit-1"], declaredMigrations: null, dependsOn: [], lastActivityAt: "2026-09-03T09:00:00.000Z",
      nodeKey: "node-a", nodeRef: "node-a", objective: "Build the ledger", landing: null, receipt: null,
    ...
    publish: null, run: { approval: "BOUND", lifecycle: "ACTIVATED", reviewable: false, runId: "run-1" }, title: "Alpha",
  }],
  status: "RUNS",
