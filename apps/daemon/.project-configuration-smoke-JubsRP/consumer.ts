...
let store = SqliteEventStore.openForProject("/mnt/d/projexts/moe-next/apps/daemon/.project-configuration-smoke-JubsRP/consumer.db", projectId);
try {
...
store = SqliteEventStore.openForProject("/mnt/d/projexts/moe-next/apps/daemon/.project-configuration-smoke-JubsRP/consumer.db", projectId);
try {
