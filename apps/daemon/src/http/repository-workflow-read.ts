...
type Workflow = "BOOTSTRAP" | "CRITERIA" | "RECOVERY";
...
export type RepositoryWorkflowReadDispatch =
  | { readonly kind: "REPLY"; readonly httpStatus: number; readonly body: BootstrapReadView | CriterionEvidenceRead | RepositoryRecoveryView | Refusal | HttpPortRefused | HttpRefused }
...
export function handleRepositoryWorkflowReadRequest(workflow: Workflow,
  ...
  const valid = object !== null && (workflow !== "CRITERIA" ? Object.keys(object).length === 0
