...
const WRITER_ONLY: readonly string[] = Object.freeze([
  ...
  // The binding read that threw inside the write command; no reader re-derives it.
  "STEP_BINDING_UNREADABLE",
  "JOURNAL_REQUEST_MALFORMED", "JOURNAL_ENTRY_MALFORMED", "JOURNAL_ENTRY_LIST_EMPTY",
  "JOURNAL_COMMIT_UNAVAILABLE", "JOURNAL_BINDING_UNREADABLE",
  ...
  "FOUNDATION_ARTIFACT_LEDGER_CONFLICT", "FOUNDATION_ARTIFACT_LEDGER_IMMUTABLE",
