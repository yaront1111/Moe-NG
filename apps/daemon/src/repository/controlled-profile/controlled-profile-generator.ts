 ...
 * STARTED as. If two bootstraps of `controlled-4` could differ, none of those claims hold across
 ...
 */
// controlled-4 changes only compose: no dependencies moved, so it deliberately reuses v2's lock.
