...
let store = SqliteEventStore.openForProject("/mnt/d/projexts/moe-next/apps/daemon/.project-configuration-smoke-IYs7yu/consumer.db", projectId);
try {
...
store = SqliteEventStore.openForProject("/mnt/d/projexts/moe-next/apps/daemon/.project-configuration-smoke-IYs7yu/consumer.db", projectId);
try {
