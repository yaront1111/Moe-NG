...
let store = SqliteEventStore.openForProject("/mnt/d/projexts/moe-next/apps/daemon/.project-configuration-smoke-6YmjK6/consumer.db", projectId);
try {
...
store = SqliteEventStore.openForProject("/mnt/d/projexts/moe-next/apps/daemon/.project-configuration-smoke-6YmjK6/consumer.db", projectId);
try {
