...
let store = SqliteEventStore.openForProject("/mnt/d/projexts/moe-next/apps/daemon/.project-configuration-smoke-NUpi5q/consumer.db", projectId);
try {
...
store = SqliteEventStore.openForProject("/mnt/d/projexts/moe-next/apps/daemon/.project-configuration-smoke-NUpi5q/consumer.db", projectId);
try {
