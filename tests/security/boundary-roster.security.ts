 ...
 * with a WIDE numerator over a WIDE denominator; the narrow width measures 61 of 229 and is
...
const EXPECTED_INVISIBLE_DENOMINATOR = 230;
const EXPECTED_INVISIBLE_SHARE_PER_MILLE = 270;
...
describe("TASK-LV module-private layer declarations are bounded", () => {
  ...
  it("TASK-LV pins the invisible share at the wide pattern width, numerator and denominator both named", () => {
    ...
    // Both at the WIDE `[A-Z0-9_]+` width — the narrow width measures 61 of 229 and is equally
