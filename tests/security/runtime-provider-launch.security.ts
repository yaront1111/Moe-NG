...
describe("CLAUDE_LAUNCH_LAYERS", () => {
  ...
  // These probes target request admission; select Windows explicitly so the host-platform
  // refusal cannot answer before the malformed request reaches the gate under test.
