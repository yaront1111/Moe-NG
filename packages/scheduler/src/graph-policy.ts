 ...
 *
 * These names are the single source of truth for the numbers; callers may
 * override them via an explicit {@link GraphPolicy} argument. There are no
 * duplicated magic numbers elsewhere in the kernel.
 */
