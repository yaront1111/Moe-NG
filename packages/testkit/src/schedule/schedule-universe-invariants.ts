...
export const CORE_INVARIANT_SCHEDULES: readonly ScheduleDefinition[] = Object.freeze([
  ...
  defineSchedule("CORE-I8-PARTIAL-ORDER", ["CORE-I8"], multi,
    [EDGE.gAdvanceEpoch, EDGE.gReopenCompleted, EDGE.revActivate, EDGE.revApprove],
    [RACE.dActivateResume, RACE.eAdvanceCancel, RACE.eAdvanceClose,
      RACE.eAdvancePause, RACE.eAdvanceResume],
